 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var zg;function vS(){if(zg)return ae;zg=1;var o=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),h=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),S=Symbol.iterator;function v(D){return D===null||typeof D!="object"?null:(D=S&&D[S]||D["@@iterator"],typeof D=="function"?D:null)}var y={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},b=Object.assign,w={};function M(D,tt,vt){this.props=D,this.context=tt,this.refs=w,this.updater=vt||y}M.prototype.isReactComponent={},M.prototype.setState=function(D,tt){if(typeof D!="object"&&typeof D!="function"&&D!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,D,tt,"setState")},M.prototype.forceUpdate=function(D){this.updater.enqueueForceUpdate(this,D,"forceUpdate")};function _(){}_.prototype=M.prototype;function F(D,tt,vt){this.props=D,this.context=tt,this.refs=w,this.updater=vt||y}var B=F.prototype=new _;B.constructor=F,b(B,M.prototype),B.isPureReactComponent=!0;var U=Array.isArray,k={H:null,A:null,T:null,S:null,V:null},z=Object.prototype.hasOwnProperty;function L(D,tt,vt,St,J,mt){return vt=mt.ref,{$$typeof:o,type:D,key:tt,ref:vt!==void 0?vt:null,props:mt}}function W(D,tt){return L(D.type,tt,void 0,void 0,void 0,D.props)}function C(D){return typeof D=="object"&&D!==null&&D.$$typeof===o}function R(D){var tt={"=":"=0",":":"=2"};return"$"+D.replace(/[=:]/g,function(vt){return tt[vt]})}var I=/\/+/g;function rt(D,tt){return typeof D=="object"&&D!==null&&D.key!=null?R(""+D.key):tt.toString(36)}function Q(){}function ut(D){switch(D.status){case"fulfilled":return D.value;case"rejected":throw D.reason;default:switch(typeof D.status=="string"?D.then(Q,Q):(D.status="pending",D.then(function(tt){D.status==="pending"&&(D.status="fulfilled",D.value=tt)},function(tt){D.status==="pending"&&(D.status="rejected",D.reason=tt)})),D.status){case"fulfilled":return D.value;case"rejected":throw D.reason}}throw D}function ct(D,tt,vt,St,J){var mt=typeof D;(mt==="undefined"||mt==="boolean")&&(D=null);var yt=!1;if(D===null)yt=!0;else switch(mt){case"bigint":case"string":case"number":yt=!0;break;case"object":switch(D.$$typeof){case o:case e:yt=!0;break;case g:return yt=D._init,ct(yt(D._payload),tt,vt,St,J)}}if(yt)return J=J(D),yt=St===""?"."+rt(D,0):St,U(J)?(vt="",yt!=null&&(vt=yt.replace(I,"$&/")+"/"),ct(J,tt,vt,"",function(se){return se})):J!=null&&(C(J)&&(J=W(J,vt+(J.key==null||D&&D.key===J.key?"":(""+J.key).replace(I,"$&/")+"/")+yt)),tt.push(J)),1;yt=0;var bt=St===""?".":St+":";if(U(D))for(var Ct=0;Ct<D.length;Ct++)St=D[Ct],mt=bt+rt(St,Ct),yt+=ct(St,tt,vt,mt,J);else if(Ct=v(D),typeof Ct=="function")for(D=Ct.call(D),Ct=0;!(St=D.next()).done;)St=St.value,mt=bt+rt(St,Ct++),yt+=ct(St,tt,vt,mt,J);else if(mt==="object"){if(typeof D.then=="function")return ct(ut(D),tt,vt,St,J);throw tt=String(D),Error("Objects are not valid as a React child (found: "+(tt==="[object Object]"?"object with keys {"+Object.keys(D).join(", ")+"}":tt)+"). If you meant to render a collection of children, use an array instead.")}return yt}function O(D,tt,vt){if(D==null)return D;var St=[],J=0;return ct(D,St,"","",function(mt){return tt.call(vt,mt,J++)}),St}function X(D){if(D._status===-1){var tt=D._result;tt=tt(),tt.then(function(vt){(D._status===0||D._status===-1)&&(D._status=1,D._result=vt)},function(vt){(D._status===0||D._status===-1)&&(D._status=2,D._result=vt)}),D._status===-1&&(D._status=0,D._result=tt)}if(D._status===1)return D._result.default;throw D._result}var q=typeof reportError=="function"?reportError:function(D){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var tt=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof D=="object"&&D!==null&&typeof D.message=="string"?String(D.message):String(D),error:D});if(!window.dispatchEvent(tt))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",D);return}console.error(D)};function Mt(){}return ae.Children={map:O,forEach:function(D,tt,vt){O(D,function(){tt.apply(this,arguments)},vt)},count:function(D){var tt=0;return O(D,function(){tt++}),tt},toArray:function(D){return O(D,function(tt){return tt})||[]},only:function(D){if(!C(D))throw Error("React.Children.only expected to receive a single React element child.");return D}},ae.Component=M,ae.Fragment=i,ae.Profiler=l,ae.PureComponent=F,ae.StrictMode=r,ae.Suspense=m,ae.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=k,ae.__COMPILER_RUNTIME={__proto__:null,c:function(D){return k.H.useMemoCache(D)}},ae.cache=function(D){return function(){return D.apply(null,arguments)}},ae.cloneElement=function(D,tt,vt){if(D==null)throw Error("The argument must be a React element, but you passed "+D+".");var St=b({},D.props),J=D.key,mt=void 0;if(tt!=null)for(yt in tt.ref!==void 0&&(mt=void 0),tt.key!==void 0&&(J=""+tt.key),tt)!z.call(tt,yt)||yt==="key"||yt==="__self"||yt==="__source"||yt==="ref"&&tt.ref===void 0||(St[yt]=tt[yt]);var yt=arguments.length-2;if(yt===1)St.children=vt;else if(1<yt){for(var bt=Array(yt),Ct=0;Ct<yt;Ct++)bt[Ct]=arguments[Ct+2];St.children=bt}return L(D.type,J,void 0,void 0,mt,St)},ae.createContext=function(D){return D={$$typeof:h,_currentValue:D,_currentValue2:D,_threadCount:0,Provider:null,Consumer:null},D.Provider=D,D.Consumer={$$typeof:c,_context:D},D},ae.createElement=function(D,tt,vt){var St,J={},mt=null;if(tt!=null)for(St in tt.key!==void 0&&(mt=""+tt.key),tt)z.call(tt,St)&&St!=="key"&&St!=="__self"&&St!=="__source"&&(J[St]=tt[St]);var yt=arguments.length-2;if(yt===1)J.children=vt;else if(1<yt){for(var bt=Array(yt),Ct=0;Ct<yt;Ct++)bt[Ct]=arguments[Ct+2];J.children=bt}if(D&&D.defaultProps)for(St in yt=D.defaultProps,yt)J[St]===void 0&&(J[St]=yt[St]);return L(D,mt,void 0,void 0,null,J)},ae.createRef=function(){return{current:null}},ae.forwardRef=function(D){return{$$typeof:d,render:D}},ae.isValidElement=C,ae.lazy=function(D){return{$$typeof:g,_payload:{_status:-1,_result:D},_init:X}},ae.memo=function(D,tt){return{$$typeof:p,type:D,compare:tt===void 0?null:tt}},ae.startTransition=function(D){var tt=k.T,vt={};k.T=vt;try{var St=D(),J=k.S;J!==null&&J(vt,St),typeof St=="object"&&St!==null&&typeof St.then=="function"&&St.then(Mt,q)}catch(mt){q(mt)}finally{k.T=tt}},ae.unstable_useCacheRefresh=function(){return k.H.useCacheRefresh()},ae.use=function(D){return k.H.use(D)},ae.useActionState=function(D,tt,vt){return k.H.useActionState(D,tt,vt)},ae.useCallback=function(D,tt){return k.H.useCallback(D,tt)},ae.useContext=function(D){return k.H.useContext(D)},ae.useDebugValue=function(){},ae.useDeferredValue=function(D,tt){return k.H.useDeferredValue(D,tt)},ae.useEffect=function(D,tt,vt){var St=k.H;if(typeof vt=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return St.useEffect(D,tt)},ae.useId=function(){return k.H.useId()},ae.useImperativeHandle=function(D,tt,vt){return k.H.useImperativeHandle(D,tt,vt)},ae.useInsertionEffect=function(D,tt){return k.H.useInsertionEffect(D,tt)},ae.useLayoutEffect=function(D,tt){return k.H.useLayoutEffect(D,tt)},ae.useMemo=function(D,tt){return k.H.useMemo(D,tt)},ae.useOptimistic=function(D,tt){return k.H.useOptimistic(D,tt)},ae.useReducer=function(D,tt,vt){return k.H.useReducer(D,tt,vt)},ae.useRef=function(D){return k.H.useRef(D)},ae.useState=function(D){return k.H.useState(D)},ae.useSyncExternalStore=function(D,tt,vt){return k.H.useSyncExternalStore(D,tt,vt)},ae.useTransition=function(){return k.H.useTransition()},ae.version="19.1.1",ae}var Fg;function Qh(){return Fg||(Fg=1,Rf.exports=vS()),Rf.exports}var cs=Qh(),Cf={exports:{}},go={},wf={exports:{}},Df={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ig;function SS(){return Ig||(Ig=1,(function(o){function e(O,X){var q=O.length;O.push(X);t:for(;0<q;){var Mt=q-1>>>1,D=O[Mt];if(0<l(D,X))O[Mt]=X,O[q]=D,q=Mt;else break t}}function i(O){return O.length===0?null:O[0]}function r(O){if(O.length===0)return null;var X=O[0],q=O.pop();if(q!==X){O[0]=q;t:for(var Mt=0,D=O.length,tt=D>>>1;Mt<tt;){var vt=2*(Mt+1)-1,St=O[vt],J=vt+1,mt=O[J];if(0>l(St,q))J<D&&0>l(mt,St)?(O[Mt]=mt,O[J]=q,Mt=J):(O[Mt]=St,O[vt]=q,Mt=vt);else if(J<D&&0>l(mt,q))O[Mt]=mt,O[J]=q,Mt=J;else break t}}return X}function l(O,X){var q=O.sortIndex-X.sortIndex;return q!==0?q:O.id-X.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;o.unstable_now=function(){return c.now()}}else{var h=Date,d=h.now();o.unstable_now=function(){return h.now()-d}}var m=[],p=[],g=1,S=null,v=3,y=!1,b=!1,w=!1,M=!1,_=typeof setTimeout=="function"?setTimeout:null,F=typeof clearTimeout=="function"?clearTimeout:null,B=typeof setImmediate<"u"?setImmediate:null;function U(O){for(var X=i(p);X!==null;){if(X.callback===null)r(p);else if(X.startTime<=O)r(p),X.sortIndex=X.expirationTime,e(m,X);else break;X=i(p)}}function k(O){if(w=!1,U(O),!b)if(i(m)!==null)b=!0,z||(z=!0,rt());else{var X=i(p);X!==null&&ct(k,X.startTime-O)}}var z=!1,L=-1,W=5,C=-1;function R(){return M?!0:!(o.unstable_now()-C<W)}function I(){if(M=!1,z){var O=o.unstable_now();C=O;var X=!0;try{t:{b=!1,w&&(w=!1,F(L),L=-1),y=!0;var q=v;try{e:{for(U(O),S=i(m);S!==null&&!(S.expirationTime>O&&R());){var Mt=S.callback;if(typeof Mt=="function"){S.callback=null,v=S.priorityLevel;var D=Mt(S.expirationTime<=O);if(O=o.unstable_now(),typeof D=="function"){S.callback=D,U(O),X=!0;break e}S===i(m)&&r(m),U(O)}else r(m);S=i(m)}if(S!==null)X=!0;else{var tt=i(p);tt!==null&&ct(k,tt.startTime-O),X=!1}}break t}finally{S=null,v=q,y=!1}X=void 0}}finally{X?rt():z=!1}}}var rt;if(typeof B=="function")rt=function(){B(I)};else if(typeof MessageChannel<"u"){var Q=new MessageChannel,ut=Q.port2;Q.port1.onmessage=I,rt=function(){ut.postMessage(null)}}else rt=function(){_(I,0)};function ct(O,X){L=_(function(){O(o.unstable_now())},X)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(O){O.callback=null},o.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):W=0<O?Math.floor(1e3/O):5},o.unstable_getCurrentPriorityLevel=function(){return v},o.unstable_next=function(O){switch(v){case 1:case 2:case 3:var X=3;break;default:X=v}var q=v;v=X;try{return O()}finally{v=q}},o.unstable_requestPaint=function(){M=!0},o.unstable_runWithPriority=function(O,X){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var q=v;v=O;try{return X()}finally{v=q}},o.unstable_scheduleCallback=function(O,X,q){var Mt=o.unstable_now();switch(typeof q=="object"&&q!==null?(q=q.delay,q=typeof q=="number"&&0<q?Mt+q:Mt):q=Mt,O){case 1:var D=-1;break;case 2:D=250;break;case 5:D=1073741823;break;case 4:D=1e4;break;default:D=5e3}return D=q+D,O={id:g++,callback:X,priorityLevel:O,startTime:q,expirationTime:D,sortIndex:-1},q>Mt?(O.sortIndex=q,e(p,O),i(m)===null&&O===i(p)&&(w?(F(L),L=-1):w=!0,ct(k,q-Mt))):(O.sortIndex=D,e(m,O),b||y||(b=!0,z||(z=!0,rt()))),O},o.unstable_shouldYield=R,o.unstable_wrapCallback=function(O){var X=v;return function(){var q=v;v=X;try{return O.apply(this,arguments)}finally{v=q}}}})(Df)),Df}var Hg;function xS(){return Hg||(Hg=1,wf.exports=SS()),wf.exports}var Uf={exports:{}},An={};/**
 * @license React
...
`)+`
`+_);const B=F+M+h,U=F+_+d,k=D_(l,l.VERTEX_SHADER,B),z=D_(l,l.FRAGMENT_SHADER,U);l.attachShader(w,k),l.attachShader(w,z),i.index0AttributeName!==void 0?l.bindAttribLocation(w,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(w,0,"position"),l.linkProgram(w);function L(I){if(o.debug.checkShaderErrors){const rt=l.getProgramInfoLog(w).trim(),Q=l.getShaderInfoLog(k).trim(),ut=l.getShaderInfoLog(z).trim();let ct=!0,O=!0;if(l.getProgramParameter(w,l.LINK_STATUS)===!1)if(ct=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,w,k,z);else{const X=L_(l,k,"vertex"),q=L_(l,z,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(w,l.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      }`,Q=L.createProgram();L.attachShader(Q,z(L.VERTEX_SHADER,I)),L.attachShader(Q,z(L.FRAGMENT_SHADER,rt)),L.linkProgram(Q);const ut=L.createTexture();L.bindTexture(L.TEXTURE_2D,ut),L.texParameteri(L.TEXTURE_2D,L.TEXTURE_MIN_FILTER,L.NEAREST),L.texParameteri(L.TEXTURE_2D,L.TEXTURE_MAG_FILTER,L.NEAREST),L.texParameteri(L.TEXTURE_2D,L.TEXTURE_WRAP_S,L.CLAMP_TO_EDGE),L.texParameteri(L.TEXTURE_2D,L.TEXTURE_WRAP_T,L.CLAMP_TO_EDGE);const ct=L.getUniformLocation(Q,"uTex");p.current={prog:Q,vao:C,quadTex:ut,uTexLoc:ct}}const _=async()=>{await tf.setBackend("webgpu"),await tf.ready(),c=await tf.loadGraphModel("./tfjs/model.json"),console.log("✅ Model loaded")},F=async()=>{await _(),S=new Xx,v=new ri,g=new PA({antialias:!0,alpha:!0}),g.setSize(window.innerWidth,window.innerHeight),g.xr.enabled=!0,o.current.appendChild(g.domElement),document.body.appendChild(BA.createButton(g,{requiredFeatures:["camera-access"],optionalFeatures:["local"]})),g.xr.addEventListener("sessionstart",async()=>{const z=g.xr.getSession();y=await z.requestReferenceSpace("local"),b=new XRWebGLBinding(z,g.getContext()),console.log("🟢 XRWebGLBinding created");const L=1,W=window.innerWidth/window.innerHeight,C=v.fov*Math.PI/180,R=2*L*Math.tan(C/2),I=R*W;console.log("DEBUG quad size:",{planeW:I,planeH:R,distance:L});const rt=new Lo(I,R),Q=new Zx(e);Q.wrapS=ji,Q.wrapT=ji,Q.minFilter=Zn,Q.magFilter=Zn;const ut=new od({map:Q,transparent:!0});h=new yi(rt,ut),h.position.set(0,0,-L),v.add(h),S.add(v),z.requestAnimationFrame(k)})};function B(z,L,W,C,R){const I=z.createFramebuffer();z.bindFramebuffer(z.FRAMEBUFFER,I),z.framebufferTexture2D(z.FRAMEBUFFER,z.COLOR_ATTACHMENT0,z.TEXTURE_2D,L,0);const rt=new Uint8Array(W*C*4);console.time("READ TIME"),z.readPixels(0,0,W,C,z.RGBA,z.UNSIGNED_BYTE,rt),console.timeEnd("READ TIME"),z.bindFramebuffer(z.FRAMEBUFFER,R),z.deleteFramebuffer(I);const Q=document.createElement("canvas");Q.width=W,Q.height=C;const ut=Q.getContext("2d"),ct=ut.createImageData(W,C),O=new Uint8ClampedArray(W*C*4);for(let St=0;St<C;St++)O.set(rt.subarray((C-1-St)*W*4,(C-St)*W*4),St*W*4);ct.data.set(O),ut.putImageData(ct,0,0);const X=m.current,{prog:q,vao:Mt,quadTex:D,uTexLoc:tt}=p.current;X.useProgram(q),X.bindVertexArray(Mt),X.viewport(0,0,i,r),X.clearColor(0,0,0,0),X.clear(X.COLOR_BUFFER_BIT),X.activeTexture(X.TEXTURE0),X.bindTexture(X.TEXTURE_2D,D),X.pixelStorei(X.UNPACK_FLIP_Y_WEBGL,!0),X.texImage2D(X.TEXTURE_2D,0,X.RGBA,X.RGBA,X.UNSIGNED_BYTE,Q),X.uniform1i(tt,0),X.drawArrays(X.TRIANGLES,0,6),X.finish();const vt=d.current.toDataURL("image/png");return console.log("🖼️ Resized canvas:",vt),d.current}async function U(z){const L=tf.browser.fromPixels(z).expandDims(0).toFloat().div(255),W=performance.now(),C=await c.predict(L),R=performance.now();console.log(`inference: ${R-W}ms`);const I=C.argMax(-1).squeeze(),rt=await I.data();I.dispose(),C.dispose(),L.dispose();const Q=l.createImageData(i,r);for(let ut=0;ut<rt.length;ut++){const ct=rt[ut]>=1;Q.data[ut*4+0]=255,Q.data[ut*4+1]=255,Q.data[ut*4+2]=0,Q.data[ut*4+3]=ct?100:0}l.putImageData(Q,0,0),h.material.map.needsUpdate=!0}function k(z,L){const W=L.session;W.requestAnimationFrame(k);const C=L.getViewerPose(y);if(!C)return;const R=g.getContext(),I=W.renderState.baseLayer;R.bindFramebuffer(R.FRAMEBUFFER,I.framebuffer),R.clear(R.COLOR_BUFFER_BIT|R.DEPTH_BUFFER_BIT);for(const rt of C.views)if(rt.camera){const Q=rt.camera.width,ut=rt.camera.height;console.log("📷 camera view",Q,ut);const ct=b.getCameraImage(rt.camera),O=B(R,ct,Q,ut,I.framebuffer);U(O)}g.render(S,v)}return F(),()=>g?.dispose()},[]),uh.jsx("div",{ref:o,style:{width:"100vw",height:"100vh",overflow:"hidden"}})}AS.createRoot(document.getElementById("root")).render(uh.jsx(cs.StrictMode,{children:uh.jsx(zA,{})}));
