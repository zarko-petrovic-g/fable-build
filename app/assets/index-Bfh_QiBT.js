 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var B_;function vS(){if(B_)return ae;B_=1;var o=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),h=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),S=Symbol.iterator;function x(U){return U===null||typeof U!="object"?null:(U=S&&U[S]||U["@@iterator"],typeof U=="function"?U:null)}var y={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},b=Object.assign,C={};function _(U,$,vt){this.props=U,this.context=$,this.refs=C,this.updater=vt||y}_.prototype.isReactComponent={},_.prototype.setState=function(U,$){if(typeof U!="object"&&typeof U!="function"&&U!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,U,$,"setState")},_.prototype.forceUpdate=function(U){this.updater.enqueueForceUpdate(this,U,"forceUpdate")};function v(){}v.prototype=_.prototype;function B(U,$,vt){this.props=U,this.context=$,this.refs=C,this.updater=vt||y}var P=B.prototype=new v;P.constructor=B,b(P,_.prototype),P.isPureReactComponent=!0;var D=Array.isArray,V={H:null,A:null,T:null,S:null,V:null},X=Object.prototype.hasOwnProperty;function F(U,$,vt,Mt,Q,mt){return vt=mt.ref,{$$typeof:o,type:U,key:$,ref:vt!==void 0?vt:null,props:mt}}function K(U,$){return F(U.type,$,void 0,void 0,void 0,U.props)}function w(U){return typeof U=="object"&&U!==null&&U.$$typeof===o}function R(U){var $={"=":"=0",":":"=2"};return"$"+U.replace(/[=:]/g,function(vt){return $[vt]})}var H=/\/+/g;function lt(U,$){return typeof U=="object"&&U!==null&&U.key!=null?R(""+U.key):$.toString(36)}function rt(){}function ct(U){switch(U.status){case"fulfilled":return U.value;case"rejected":throw U.reason;default:switch(typeof U.status=="string"?U.then(rt,rt):(U.status="pending",U.then(function($){U.status==="pending"&&(U.status="fulfilled",U.value=$)},function($){U.status==="pending"&&(U.status="rejected",U.reason=$)})),U.status){case"fulfilled":return U.value;case"rejected":throw U.reason}}throw U}function ot(U,$,vt,Mt,Q){var mt=typeof U;(mt==="undefined"||mt==="boolean")&&(U=null);var yt=!1;if(U===null)yt=!0;else switch(mt){case"bigint":case"string":case"number":yt=!0;break;case"object":switch(U.$$typeof){case o:case e:yt=!0;break;case g:return yt=U._init,ot(yt(U._payload),$,vt,Mt,Q)}}if(yt)return Q=Q(U),yt=Mt===""?"."+lt(U,0):Mt,D(Q)?(vt="",yt!=null&&(vt=yt.replace(H,"$&/")+"/"),ot(Q,$,vt,"",function(se){return se})):Q!=null&&(w(Q)&&(Q=K(Q,vt+(Q.key==null||U&&U.key===Q.key?"":(""+Q.key).replace(H,"$&/")+"/")+yt)),$.push(Q)),1;yt=0;var bt=Mt===""?".":Mt+":";if(D(U))for(var Ct=0;Ct<U.length;Ct++)Mt=U[Ct],mt=bt+lt(Mt,Ct),yt+=ot(Mt,$,vt,mt,Q);else if(Ct=x(U),typeof Ct=="function")for(U=Ct.call(U),Ct=0;!(Mt=U.next()).done;)Mt=Mt.value,mt=bt+lt(Mt,Ct++),yt+=ot(Mt,$,vt,mt,Q);else if(mt==="object"){if(typeof U.then=="function")return ot(ct(U),$,vt,Mt,Q);throw $=String(U),Error("Objects are not valid as a React child (found: "+($==="[object Object]"?"object with keys {"+Object.keys(U).join(", ")+"}":$)+"). If you meant to render a collection of children, use an array instead.")}return yt}function L(U,$,vt){if(U==null)return U;var Mt=[],Q=0;return ot(U,Mt,"","",function(mt){return $.call(vt,mt,Q++)}),Mt}function Y(U){if(U._status===-1){var $=U._result;$=$(),$.then(function(vt){(U._status===0||U._status===-1)&&(U._status=1,U._result=vt)},function(vt){(U._status===0||U._status===-1)&&(U._status=2,U._result=vt)}),U._status===-1&&(U._status=0,U._result=$)}if(U._status===1)return U._result.default;throw U._result}var W=typeof reportError=="function"?reportError:function(U){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var $=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof U=="object"&&U!==null&&typeof U.message=="string"?String(U.message):String(U),error:U});if(!window.dispatchEvent($))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",U);return}console.error(U)};function St(){}return ae.Children={map:L,forEach:function(U,$,vt){L(U,function(){$.apply(this,arguments)},vt)},count:function(U){var $=0;return L(U,function(){$++}),$},toArray:function(U){return L(U,function($){return $})||[]},only:function(U){if(!w(U))throw Error("React.Children.only expected to receive a single React element child.");return U}},ae.Component=_,ae.Fragment=i,ae.Profiler=l,ae.PureComponent=B,ae.StrictMode=r,ae.Suspense=m,ae.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=V,ae.__COMPILER_RUNTIME={__proto__:null,c:function(U){return V.H.useMemoCache(U)}},ae.cache=function(U){return function(){return U.apply(null,arguments)}},ae.cloneElement=function(U,$,vt){if(U==null)throw Error("The argument must be a React element, but you passed "+U+".");var Mt=b({},U.props),Q=U.key,mt=void 0;if($!=null)for(yt in $.ref!==void 0&&(mt=void 0),$.key!==void 0&&(Q=""+$.key),$)!X.call($,yt)||yt==="key"||yt==="__self"||yt==="__source"||yt==="ref"&&$.ref===void 0||(Mt[yt]=$[yt]);var yt=arguments.length-2;if(yt===1)Mt.children=vt;else if(1<yt){for(var bt=Array(yt),Ct=0;Ct<yt;Ct++)bt[Ct]=arguments[Ct+2];Mt.children=bt}return F(U.type,Q,void 0,void 0,mt,Mt)},ae.createContext=function(U){return U={$$typeof:h,_currentValue:U,_currentValue2:U,_threadCount:0,Provider:null,Consumer:null},U.Provider=U,U.Consumer={$$typeof:c,_context:U},U},ae.createElement=function(U,$,vt){var Mt,Q={},mt=null;if($!=null)for(Mt in $.key!==void 0&&(mt=""+$.key),$)X.call($,Mt)&&Mt!=="key"&&Mt!=="__self"&&Mt!=="__source"&&(Q[Mt]=$[Mt]);var yt=arguments.length-2;if(yt===1)Q.children=vt;else if(1<yt){for(var bt=Array(yt),Ct=0;Ct<yt;Ct++)bt[Ct]=arguments[Ct+2];Q.children=bt}if(U&&U.defaultProps)for(Mt in yt=U.defaultProps,yt)Q[Mt]===void 0&&(Q[Mt]=yt[Mt]);return F(U,mt,void 0,void 0,null,Q)},ae.createRef=function(){return{current:null}},ae.forwardRef=function(U){return{$$typeof:d,render:U}},ae.isValidElement=w,ae.lazy=function(U){return{$$typeof:g,_payload:{_status:-1,_result:U},_init:Y}},ae.memo=function(U,$){return{$$typeof:p,type:U,compare:$===void 0?null:$}},ae.startTransition=function(U){var $=V.T,vt={};V.T=vt;try{var Mt=U(),Q=V.S;Q!==null&&Q(vt,Mt),typeof Mt=="object"&&Mt!==null&&typeof Mt.then=="function"&&Mt.then(St,W)}catch(mt){W(mt)}finally{V.T=$}},ae.unstable_useCacheRefresh=function(){return V.H.useCacheRefresh()},ae.use=function(U){return V.H.use(U)},ae.useActionState=function(U,$,vt){return V.H.useActionState(U,$,vt)},ae.useCallback=function(U,$){return V.H.useCallback(U,$)},ae.useContext=function(U){return V.H.useContext(U)},ae.useDebugValue=function(){},ae.useDeferredValue=function(U,$){return V.H.useDeferredValue(U,$)},ae.useEffect=function(U,$,vt){var Mt=V.H;if(typeof vt=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return Mt.useEffect(U,$)},ae.useId=function(){return V.H.useId()},ae.useImperativeHandle=function(U,$,vt){return V.H.useImperativeHandle(U,$,vt)},ae.useInsertionEffect=function(U,$){return V.H.useInsertionEffect(U,$)},ae.useLayoutEffect=function(U,$){return V.H.useLayoutEffect(U,$)},ae.useMemo=function(U,$){return V.H.useMemo(U,$)},ae.useOptimistic=function(U,$){return V.H.useOptimistic(U,$)},ae.useReducer=function(U,$,vt){return V.H.useReducer(U,$,vt)},ae.useRef=function(U){return V.H.useRef(U)},ae.useState=function(U){return V.H.useState(U)},ae.useSyncExternalStore=function(U,$,vt){return V.H.useSyncExternalStore(U,$,vt)},ae.useTransition=function(){return V.H.useTransition()},ae.version="19.1.1",ae}var z_;function Qh(){return z_||(z_=1,bf.exports=vS()),bf.exports}var uh=Qh(),Rf={exports:{}},mo={},Cf={exports:{}},wf={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var F_;function SS(){return F_||(F_=1,(function(o){function e(L,Y){var W=L.length;L.push(Y);t:for(;0<W;){var St=W-1>>>1,U=L[St];if(0<l(U,Y))L[St]=Y,L[W]=U,W=St;else break t}}function i(L){return L.length===0?null:L[0]}function r(L){if(L.length===0)return null;var Y=L[0],W=L.pop();if(W!==Y){L[0]=W;t:for(var St=0,U=L.length,$=U>>>1;St<$;){var vt=2*(St+1)-1,Mt=L[vt],Q=vt+1,mt=L[Q];if(0>l(Mt,W))Q<U&&0>l(mt,Mt)?(L[St]=mt,L[Q]=W,St=Q):(L[St]=Mt,L[vt]=W,St=vt);else if(Q<U&&0>l(mt,W))L[St]=mt,L[Q]=W,St=Q;else break t}}return Y}function l(L,Y){var W=L.sortIndex-Y.sortIndex;return W!==0?W:L.id-Y.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;o.unstable_now=function(){return c.now()}}else{var h=Date,d=h.now();o.unstable_now=function(){return h.now()-d}}var m=[],p=[],g=1,S=null,x=3,y=!1,b=!1,C=!1,_=!1,v=typeof setTimeout=="function"?setTimeout:null,B=typeof clearTimeout=="function"?clearTimeout:null,P=typeof setImmediate<"u"?setImmediate:null;function D(L){for(var Y=i(p);Y!==null;){if(Y.callback===null)r(p);else if(Y.startTime<=L)r(p),Y.sortIndex=Y.expirationTime,e(m,Y);else break;Y=i(p)}}function V(L){if(C=!1,D(L),!b)if(i(m)!==null)b=!0,X||(X=!0,lt());else{var Y=i(p);Y!==null&&ot(V,Y.startTime-L)}}var X=!1,F=-1,K=5,w=-1;function R(){return _?!0:!(o.unstable_now()-w<K)}function H(){if(_=!1,X){var L=o.unstable_now();w=L;var Y=!0;try{t:{b=!1,C&&(C=!1,B(F),F=-1),y=!0;var W=x;try{e:{for(D(L),S=i(m);S!==null&&!(S.expirationTime>L&&R());){var St=S.callback;if(typeof St=="function"){S.callback=null,x=S.priorityLevel;var U=St(S.expirationTime<=L);if(L=o.unstable_now(),typeof U=="function"){S.callback=U,D(L),Y=!0;break e}S===i(m)&&r(m),D(L)}else r(m);S=i(m)}if(S!==null)Y=!0;else{var $=i(p);$!==null&&ot(V,$.startTime-L),Y=!1}}break t}finally{S=null,x=W,y=!1}Y=void 0}}finally{Y?lt():X=!1}}}var lt;if(typeof P=="function")lt=function(){P(H)};else if(typeof MessageChannel<"u"){var rt=new MessageChannel,ct=rt.port2;rt.port1.onmessage=H,lt=function(){ct.postMessage(null)}}else lt=function(){v(H,0)};function ot(L,Y){F=v(function(){L(o.unstable_now())},Y)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(L){L.callback=null},o.unstable_forceFrameRate=function(L){0>L||125<L?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):K=0<L?Math.floor(1e3/L):5},o.unstable_getCurrentPriorityLevel=function(){return x},o.unstable_next=function(L){switch(x){case 1:case 2:case 3:var Y=3;break;default:Y=x}var W=x;x=Y;try{return L()}finally{x=W}},o.unstable_requestPaint=function(){_=!0},o.unstable_runWithPriority=function(L,Y){switch(L){case 1:case 2:case 3:case 4:case 5:break;default:L=3}var W=x;x=L;try{return Y()}finally{x=W}},o.unstable_scheduleCallback=function(L,Y,W){var St=o.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?St+W:St):W=St,L){case 1:var U=-1;break;case 2:U=250;break;case 5:U=1073741823;break;case 4:U=1e4;break;default:U=5e3}return U=W+U,L={id:g++,callback:Y,priorityLevel:L,startTime:W,expirationTime:U,sortIndex:-1},W>St?(L.sortIndex=W,e(p,L),i(m)===null&&L===i(p)&&(C?(B(F),F=-1):C=!0,ot(V,W-St))):(L.sortIndex=U,e(m,L),b||y||(b=!0,X||(X=!0,lt()))),L},o.unstable_shouldYield=R,o.unstable_wrapCallback=function(L){var Y=x;return function(){var W=x;x=Y;try{return L.apply(this,arguments)}finally{x=W}}}})(wf)),wf}var I_;function xS(){return I_||(I_=1,Cf.exports=SS()),Cf.exports}var Df={exports:{}},An={};/**
 * @license React
...
`)+`
`+v);const P=B+_+h,D=B+v+d,V=wg(l,l.VERTEX_SHADER,P),X=wg(l,l.FRAGMENT_SHADER,D);l.attachShader(C,V),l.attachShader(C,X),i.index0AttributeName!==void 0?l.bindAttribLocation(C,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(C,0,"position"),l.linkProgram(C);function F(H){if(o.debug.checkShaderErrors){const lt=l.getProgramInfoLog(C).trim(),rt=l.getShaderInfoLog(V).trim(),ct=l.getShaderInfoLog(X).trim();let ot=!0,L=!0;if(l.getProgramParameter(C,l.LINK_STATUS)===!1)if(ot=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,C,V,X);else{const Y=Ug(l,V,"vertex"),W=Ug(l,X,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(C,l.VALIDATE_STATUS)+`
